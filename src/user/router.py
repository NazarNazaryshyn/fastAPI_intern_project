...
async def get_all_users(current_user: str = Depends(current_user)):
...
async def get_user(user_id: int, current_user: str = Depends(current_user)):
...
async def update_user(user_id: int, user: UserUpdateSchema, current_user: str = Depends(current_user)):
...
async def delete_user(user_id: int, current_user: str = Depends(current_user)):
